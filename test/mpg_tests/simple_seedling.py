...
def generate_simple_mpg_seedling():
    ...
    internodeelement = g.add_component(internode, **PropsConfig(scale=g.scales.SubOrgan, edge_type='/', label=g.labels.SubOrgan.StemElement))
    ...
    leafelement1 = g.add_component_with_topo(leaf, internodeelement, **PropsConfig(scale=g.scales.SubOrgan, edge_type='+', label=g.labels.SubOrgan.LeafElement))
    ...
    internodeelement2 = g.add_component_with_topo(internode2, internodeelement, **PropsConfig(scale=g.scales.SubOrgan, edge_type='<', label=g.labels.SubOrgan.StemElement))
    ...
    leafelement4 = g.add_component_with_topo(leaf2, internodeelement2, **PropsConfig(scale=g.scales.SubOrgan, edge_type='+', label=g.labels.SubOrgan.LeafElement))
    ...
    root_segment1 = g.add_component_with_topo(root_internode1, internodeelement, **PropsConfig(scale=g.scales.SubOrgan, edge_type='+', label=g.labels.SubOrgan.RootSegment))
    ...
    root_segment4 = g.add_component_with_topo(root_internode2, root_segment2, **PropsConfig(scale=g.scales.SubOrgan, edge_type='+', label=g.labels.SubOrgan.RootSegment))
    ...
    return g, SimpleNamespace(**locals())
